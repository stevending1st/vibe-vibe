...
- <input type="checkbox" name="验收清单-checklist" value="失败请求有明确的错误提示" /> <label for="失败请求有明确的错误提示">失败请求有明确的错误提示</label>
- <input type="checkbox" name="验收清单-checklist" value="提供手动重试按钮" /> <label for="提供手动重试按钮">提供手动重试按钮</label>
- <input type="checkbox" name="验收清单-checklist" value="关键请求有自动重试" /> <label for="关键请求有自动重试">关键请求有自动重试</label>
- <input type="checkbox" name="验收清单-checklist" value="离线状态有提示" /> <label for="离线状态有提示">离线状态有提示</label>
