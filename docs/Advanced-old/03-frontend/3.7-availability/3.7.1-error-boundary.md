...
- <input type="checkbox" name="验收清单-checklist" value="关键功能模块有-error-boundary-保护" /> <label for="关键功能模块有-error-boundary-保护">关键功能模块有 Error Boundary 保护</label>
- <input type="checkbox" name="验收清单-checklist" value="有合适的-fallback-ui" /> <label for="有合适的-fallback-ui">有合适的 fallback UI</label>
- <input type="checkbox" name="验收清单-checklist" value="支持错误重试" /> <label for="支持错误重试">支持错误重试</label>
- <input type="checkbox" name="验收清单-checklist" value="生产环境有错误上报" /> <label for="生产环境有错误上报">生产环境有错误上报</label>
