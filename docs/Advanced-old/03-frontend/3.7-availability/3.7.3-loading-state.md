...
- <input type="checkbox" name="验收清单-checklist" value="页面级加载有-loadingtsx" /> <label for="页面级加载有-loadingtsx">页面级加载有 loading.tsx</label>
- <input type="checkbox" name="验收清单-checklist" value="skeleton-匹配真实布局" /> <label for="skeleton-匹配真实布局">Skeleton 匹配真实布局</label>
- <input type="checkbox" name="验收清单-checklist" value="按钮有-loading-状态" /> <label for="按钮有-loading-状态">按钮有 loading 状态</label>
- <input type="checkbox" name="验收清单-checklist" value="快速请求无闪烁" /> <label for="快速请求无闪烁">快速请求无闪烁</label>
