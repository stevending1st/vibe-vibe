...
- <input type="checkbox" name="验收清单-checklist" value="所有列表都有空态处理" /> <label for="所有列表都有空态处理">所有列表都有空态处理</label>
- <input type="checkbox" name="验收清单-checklist" value="空态有明确的下一步引导" /> <label for="空态有明确的下一步引导">空态有明确的下一步引导</label>
- <input type="checkbox" name="验收清单-checklist" value="搜索-筛选有对应的空态" /> <label for="搜索-筛选有对应的空态">搜索/筛选有对应的空态</label>
- <input type="checkbox" name="验收清单-checklist" value="空态风格与品牌一致" /> <label for="空态风格与品牌一致">空态风格与品牌一致</label>
