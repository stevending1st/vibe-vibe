...
- <input type="checkbox" name="验收清单-checklist" value="所有功能可通过键盘操作" /> <label for="所有功能可通过键盘操作">所有功能可通过键盘操作</label>
- <input type="checkbox" name="验收清单-checklist" value="焦点状态清晰可见" /> <label for="焦点状态清晰可见">焦点状态清晰可见</label>
- <input type="checkbox" name="验收清单-checklist" value="图片有合适的替代文本" /> <label for="图片有合适的替代文本">图片有合适的替代文本</label>
- <input type="checkbox" name="验收清单-checklist" value="表单有关联的标签" /> <label for="表单有关联的标签">表单有关联的标签</label>
- <input type="checkbox" name="验收清单-checklist" value="使用语义化-html" /> <label for="使用语义化-html">使用语义化 HTML</label>
- <input type="checkbox" name="验收清单-checklist" value="通过-axe-lighthouse-检测" /> <label for="通过-axe-lighthouse-检测">通过 axe/Lighthouse 检测</label>
