...
- <input type="checkbox" name="验收清单-checklist" value="日期-时间按地区格式化" /> <label for="日期-时间按地区格式化">日期/时间按地区格式化</label>
- <input type="checkbox" name="验收清单-checklist" value="货币按地区显示" /> <label for="货币按地区显示">货币按地区显示</label>
- <input type="checkbox" name="验收清单-checklist" value="地址-姓名顺序正确" /> <label for="地址-姓名顺序正确">地址/姓名顺序正确</label>
- <input type="checkbox" name="验收清单-checklist" value="布局适应文本长度变化" /> <label for="布局适应文本长度变化">布局适应文本长度变化</label>
- <input type="checkbox" name="验收清单-checklist" value="rtl-语言正确显示" /> <label for="rtl-语言正确显示">RTL 语言正确显示</label>
- <input type="checkbox" name="验收清单-checklist" value="符合目标地区法规" /> <label for="符合目标地区法规">符合目标地区法规</label>
