...
- <input type="checkbox" name="验收清单-checklist" value="文本从代码中抽离" /> <label for="文本从代码中抽离">文本从代码中抽离</label>
- <input type="checkbox" name="验收清单-checklist" value="支持语言切换" /> <label for="支持语言切换">支持语言切换</label>
- <input type="checkbox" name="验收清单-checklist" value="日期-数字正确格式化" /> <label for="日期-数字正确格式化">日期/数字正确格式化</label>
- <input type="checkbox" name="验收清单-checklist" value="seo-元数据多语言支持" /> <label for="seo-元数据多语言支持">SEO 元数据多语言支持</label>
- <input type="checkbox" name="验收清单-checklist" value="翻译键有-typescript-类型" /> <label for="翻译键有-typescript-类型">翻译键有 TypeScript 类型</label>
