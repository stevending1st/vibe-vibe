...
- <input type="checkbox" name="验收清单-checklist" value="文字对比度达到-451-aa" /> <label for="文字对比度达到-451-aa">文字对比度达到 4.5:1 (AA)</label>
- <input type="checkbox" name="验收清单-checklist" value="大字对比度达到-31" /> <label for="大字对比度达到-31">大字对比度达到 3:1</label>
- <input type="checkbox" name="验收清单-checklist" value="不只依赖颜色传达信息" /> <label for="不只依赖颜色传达信息">不只依赖颜色传达信息</label>
- <input type="checkbox" name="验收清单-checklist" value="焦点状态清晰可见" /> <label for="焦点状态清晰可见">焦点状态清晰可见</label>
- <input type="checkbox" name="验收清单-checklist" value="暗色模式对比度达标" /> <label for="暗色模式对比度达标">暗色模式对比度达标</label>
