...
- <input type="checkbox" name="验收清单-checklist" value="能够在组件树中定位目标组件" /> <label for="能够在组件树中定位目标组件">能够在组件树中定位目标组件</label>
- <input type="checkbox" name="验收清单-checklist" value="能够查看和修改组件的-props-和-state" /> <label for="能够查看和修改组件的-props-和-state">能够查看和修改组件的 Props 和 State</label>
- <input type="checkbox" name="验收清单-checklist" value="能够使用-profiler-分析渲染性能" /> <label for="能够使用-profiler-分析渲染性能">能够使用 Profiler 分析渲染性能</label>
