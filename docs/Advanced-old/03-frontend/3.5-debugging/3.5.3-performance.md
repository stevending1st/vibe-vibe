...
- <input type="checkbox" name="验收清单-checklist" value="能够录制并分析-performance-数据" /> <label for="能够录制并分析-performance-数据">能够录制并分析 Performance 数据</label>
- <input type="checkbox" name="验收清单-checklist" value="能够识别火焰图中的长任务" /> <label for="能够识别火焰图中的长任务">能够识别火焰图中的长任务</label>
- <input type="checkbox" name="验收清单-checklist" value="知道如何检测内存泄漏" /> <label for="知道如何检测内存泄漏">知道如何检测内存泄漏</label>
- <input type="checkbox" name="验收清单-checklist" value="了解-react-常用的性能优化方法" /> <label for="了解-react-常用的性能优化方法">了解 React 常用的性能优化方法</label>
