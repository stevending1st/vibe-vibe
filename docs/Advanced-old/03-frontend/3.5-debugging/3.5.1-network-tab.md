...
- <input type="checkbox" name="验收清单-checklist" value="能够找到指定的-api-请求" /> <label for="能够找到指定的-api-请求">能够找到指定的 API 请求</label>
- <input type="checkbox" name="验收清单-checklist" value="能够查看请求的状态码和响应内容" /> <label for="能够查看请求的状态码和响应内容">能够查看请求的状态码和响应内容</label>
- <input type="checkbox" name="验收清单-checklist" value="能够分析请求的时间消耗" /> <label for="能够分析请求的时间消耗">能够分析请求的时间消耗</label>
- <input type="checkbox" name="验收清单-checklist" value="知道如何复制请求为-curl" /> <label for="知道如何复制请求为-curl">知道如何复制请求为 cURL</label>
