...
- <input type="checkbox" name="验收清单-checklist" value="能够使用-consolelog-输出变量值" /> <label for="能够使用-consolelog-输出变量值">能够使用 console.log 输出变量值</label>
- <input type="checkbox" name="验收清单-checklist" value="能够看懂错误信息并定位问题文件和行号" /> <label for="能够看懂错误信息并定位问题文件和行号">能够看懂错误信息并定位问题文件和行号</label>
- <input type="checkbox" name="验收清单-checklist" value="知道如何设置断点进行调试" /> <label for="知道如何设置断点进行调试">知道如何设置断点进行调试</label>
- <input type="checkbox" name="验收清单-checklist" value="能够使用单步执行追踪代码流程" /> <label for="能够使用单步执行追踪代码流程">能够使用单步执行追踪代码流程</label>
