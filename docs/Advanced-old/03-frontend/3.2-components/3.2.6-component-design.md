...
- <input type="checkbox" name="验收清单-checklist" value="每个组件有清晰的单一职责" /> <label for="每个组件有清晰的单一职责">每个组件有清晰的单一职责</label>
- <input type="checkbox" name="验收清单-checklist" value="展示逻辑和业务逻辑适当分离" /> <label for="展示逻辑和业务逻辑适当分离">展示逻辑和业务逻辑适当分离</label>
- <input type="checkbox" name="验收清单-checklist" value="使用组合模式实现灵活性" /> <label for="使用组合模式实现灵活性">使用组合模式实现灵活性</label>
- <input type="checkbox" name="验收清单-checklist" value="文件组织清晰合理" /> <label for="文件组织清晰合理">文件组织清晰合理</label>
