...
- <input type="checkbox" name="验收清单-checklist" value="所有-api-入口都有参数验证" /> <label for="所有-api-入口都有参数验证">所有 API 入口都有参数验证</label>
- <input type="checkbox" name="验收清单-checklist" value="验证-schema-与-typescript-类型同步" /> <label for="验证-schema-与-typescript-类型同步">验证 Schema 与 TypeScript 类型同步</label>
- <input type="checkbox" name="验收清单-checklist" value="错误响应包含清晰的字段级错误信息" /> <label for="错误响应包含清晰的字段级错误信息">错误响应包含清晰的字段级错误信息</label>
- <input type="checkbox" name="验收清单-checklist" value="验证逻辑可复用抽离到独立文件" /> <label for="验证逻辑可复用抽离到独立文件">验证逻辑可复用（抽离到独立文件）</label>
