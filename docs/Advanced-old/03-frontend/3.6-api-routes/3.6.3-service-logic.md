...
- <input type="checkbox" name="验收清单-checklist" value="服务层不依赖-http-相关对象" /> <label for="服务层不依赖-http-相关对象">服务层不依赖 HTTP 相关对象</label>
- <input type="checkbox" name="验收清单-checklist" value="业务规则集中在服务层" /> <label for="业务规则集中在服务层">业务规则集中在服务层</label>
- <input type="checkbox" name="验收清单-checklist" value="使用事务处理多步骤操作" /> <label for="使用事务处理多步骤操作">使用事务处理多步骤操作</label>
- <input type="checkbox" name="验收清单-checklist" value="抛出有意义的错误信息" /> <label for="抛出有意义的错误信息">抛出有意义的错误信息</label>
