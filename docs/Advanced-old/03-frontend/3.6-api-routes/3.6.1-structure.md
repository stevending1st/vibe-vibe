...
- <input type="checkbox" name="验收清单-checklist" value="api-路径遵循-restful-规范" /> <label for="api-路径遵循-restful-规范">API 路径遵循 RESTful 规范</label>
- <input type="checkbox" name="验收清单-checklist" value="http-方法使用正确" /> <label for="http-方法使用正确">HTTP 方法使用正确</label>
- <input type="checkbox" name="验收清单-checklist" value="状态码符合语义" /> <label for="状态码符合语义">状态码符合语义</label>
- <input type="checkbox" name="验收清单-checklist" value="响应格式统一" /> <label for="响应格式统一">响应格式统一</label>
