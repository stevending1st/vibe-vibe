...
- <input type="checkbox" name="验收清单-checklist" value="有自定义错误类体系" /> <label for="有自定义错误类体系">有自定义错误类体系</label>
- <input type="checkbox" name="验收清单-checklist" value="有统一的错误处理函数" /> <label for="有统一的错误处理函数">有统一的错误处理函数</label>
- <input type="checkbox" name="验收清单-checklist" value="错误响应格式一致" /> <label for="错误响应格式一致">错误响应格式一致</label>
- <input type="checkbox" name="验收清单-checklist" value="有适当的日志记录" /> <label for="有适当的日志记录">有适当的日志记录</label>
