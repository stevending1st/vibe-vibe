...
- <input type="checkbox" name="验收清单-checklist" value="组件正确安装到-components-ui" /> <label for="组件正确安装到-components-ui">组件正确安装到 `components/ui/`</label>
- <input type="checkbox" name="验收清单-checklist" value="导入路径使用-components-ui-xxx" /> <label for="导入路径使用-components-ui-xxx">导入路径使用 `@/components/ui/xxx`</label>
- <input type="checkbox" name="验收清单-checklist" value="使用-cn-合并额外的类名" /> <label for="使用-cn-合并额外的类名">使用 `cn()` 合并额外的类名</label>
- <input type="checkbox" name="验收清单-checklist" value="表单使用-form-组件并配置验证" /> <label for="表单使用-form-组件并配置验证">表单使用 Form 组件并配置验证</label>
