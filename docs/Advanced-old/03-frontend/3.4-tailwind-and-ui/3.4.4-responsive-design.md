...
- <input type="checkbox" name="验收清单-checklist" value="默认样式针对移动端" /> <label for="默认样式针对移动端">默认样式针对移动端</label>
- <input type="checkbox" name="验收清单-checklist" value="关键断点mdlg有对应样式" /> <label for="关键断点mdlg有对应样式">关键断点（md、lg）有对应样式</label>
- <input type="checkbox" name="验收清单-checklist" value="导航在移动端可用汉堡菜单或底部导航" /> <label for="导航在移动端可用汉堡菜单或底部导航">导航在移动端可用（汉堡菜单或底部导航）</label>
- <input type="checkbox" name="验收清单-checklist" value="图片使用-sizes-属性优化加载" /> <label for="图片使用-sizes-属性优化加载">图片使用 `sizes` 属性优化加载</label>
- <input type="checkbox" name="验收清单-checklist" value="触控元素足够大" /> <label for="触控元素足够大">触控元素足够大</label>
