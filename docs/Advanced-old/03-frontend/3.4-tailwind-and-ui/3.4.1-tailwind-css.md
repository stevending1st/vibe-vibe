...
- <input type="checkbox" name="验收清单-checklist" value="类名使用正确样式符合预期" /> <label for="类名使用正确样式符合预期">类名使用正确，样式符合预期</label>
- <input type="checkbox" name="验收清单-checklist" value="响应式断点设置合理" /> <label for="响应式断点设置合理">响应式断点设置合理</label>
- <input type="checkbox" name="验收清单-checklist" value="无冗余的自定义-css" /> <label for="无冗余的自定义-css">无冗余的自定义 CSS</label>
- <input type="checkbox" name="验收清单-checklist" value="颜色使用设计系统中的值" /> <label for="颜色使用设计系统中的值">颜色使用设计系统中的值</label>
