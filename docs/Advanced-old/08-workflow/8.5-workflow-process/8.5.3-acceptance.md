...
- <input type="checkbox" name="验收清单-checklist" value="能编写明确的验收标准" /> <label for="能编写明确的验收标准">能编写明确的验收标准</label>
- <input type="checkbox" name="验收清单-checklist" value="理解功能性能安全验收的区别" /> <label for="理解功能性能安全验收的区别">理解功能、性能、安全验收的区别</label>
- <input type="checkbox" name="验收清单-checklist" value="能用自动化测试替代部分验收" /> <label for="能用自动化测试替代部分验收">能用自动化测试替代部分验收</label>
- <input type="checkbox" name="验收清单-checklist" value="知道如何记录验收结果" /> <label for="知道如何记录验收结果">知道如何记录验收结果</label>
