...
- <input type="checkbox" name="验收清单-checklist" value="成功安装-husky-和-commitlint" /> <label for="成功安装-husky-和-commitlint">成功安装 husky 和 commitlint</label>
- <input type="checkbox" name="验收清单-checklist" value="配置了-commit-msg-hook" /> <label for="配置了-commit-msg-hook">配置了 commit-msg hook</label>
- <input type="checkbox" name="验收清单-checklist" value="不规范的提交会被拒绝" /> <label for="不规范的提交会被拒绝">不规范的提交会被拒绝</label>
- <input type="checkbox" name="验收清单-checklist" value="可选配置了-lint-staged" /> <label for="可选配置了-lint-staged">可选：配置了 lint-staged</label>
