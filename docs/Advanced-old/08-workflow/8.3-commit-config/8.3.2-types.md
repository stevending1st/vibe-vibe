...
- <input type="checkbox" name="验收清单-checklist" value="能准确区分-feat-和-fix" /> <label for="能准确区分-feat-和-fix">能准确区分 feat 和 fix</label>
- <input type="checkbox" name="验收清单-checklist" value="理解-refactor-与-fix-的区别" /> <label for="理解-refactor-与-fix-的区别">理解 refactor 与 fix 的区别</label>
- <input type="checkbox" name="验收清单-checklist" value="知道-style-和-refactor-的界限" /> <label for="知道-style-和-refactor-的界限">知道 style 和 refactor 的界限</label>
- <input type="checkbox" name="验收清单-checklist" value="能根据变更内容选择正确的类型" /> <label for="能根据变更内容选择正确的类型">能根据变更内容选择正确的类型</label>
