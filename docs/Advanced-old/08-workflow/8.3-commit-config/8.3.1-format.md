...
- <input type="checkbox" name="验收清单-checklist" value="理解-headerbodyfooter-的作用" /> <label for="理解-headerbodyfooter-的作用">理解 Header、Body、Footer 的作用</label>
- <input type="checkbox" name="验收清单-checklist" value="能正确使用-scope-标注影响范围" /> <label for="能正确使用-scope-标注影响范围">能正确使用 scope 标注影响范围</label>
- <input type="checkbox" name="验收清单-checklist" value="知道如何标记破坏性变更" /> <label for="知道如何标记破坏性变更">知道如何标记破坏性变更</label>
- <input type="checkbox" name="验收清单-checklist" value="能编写清晰的-body-说明" /> <label for="能编写清晰的-body-说明">能编写清晰的 Body 说明</label>
