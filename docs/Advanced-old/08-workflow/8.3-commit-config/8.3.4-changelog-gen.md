...
- <input type="checkbox" name="验收清单-checklist" value="安装并配置-standard-version" /> <label for="安装并配置-standard-version">安装并配置 standard-version</label>
- <input type="checkbox" name="验收清单-checklist" value="能执行-release-命令生成-changelog" /> <label for="能执行-release-命令生成-changelog">能执行 release 命令生成 CHANGELOG</label>
- <input type="checkbox" name="验收清单-checklist" value="理解版本号自动变更规则" /> <label for="理解版本号自动变更规则">理解版本号自动变更规则</label>
- <input type="checkbox" name="验收清单-checklist" value="可选配置-ci-自动发布" /> <label for="可选配置-ci-自动发布">可选：配置 CI 自动发布</label>
