...
- <input type="checkbox" name="验收清单-checklist" value="能根据场景选择正确的回滚方式" /> <label for="能根据场景选择正确的回滚方式">能根据场景选择正确的回滚方式</label>
- <input type="checkbox" name="验收清单-checklist" value="知道如何用-reflog-找回误删的提交" /> <label for="知道如何用-reflog-找回误删的提交">知道如何用 reflog 找回误删的提交</label>
- <input type="checkbox" name="验收清单-checklist" value="能使用-stash-暂存工作进度" /> <label for="能使用-stash-暂存工作进度">能使用 stash 暂存工作进度</label>
