...
- <input type="checkbox" name="验收清单-checklist" value="理解-gitignore-的作用和重要性" /> <label for="理解-gitignore-的作用和重要性">理解 .gitignore 的作用和重要性</label>
- <input type="checkbox" name="验收清单-checklist" value="能编写基本的忽略规则" /> <label for="能编写基本的忽略规则">能编写基本的忽略规则</label>
- <input type="checkbox" name="验收清单-checklist" value="知道如何移除已追踪的文件" /> <label for="知道如何移除已追踪的文件">知道如何移除已追踪的文件</label>
- <input type="checkbox" name="验收清单-checklist" value="了解全局-gitignore-的配置方法" /> <label for="了解全局-gitignore-的配置方法">了解全局 .gitignore 的配置方法</label>
