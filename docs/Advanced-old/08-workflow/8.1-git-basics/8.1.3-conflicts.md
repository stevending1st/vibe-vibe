...
- <input type="checkbox" name="验收清单-checklist" value="理解冲突产生的原因" /> <label for="理解冲突产生的原因">理解冲突产生的原因</label>
- <input type="checkbox" name="验收清单-checklist" value="能识别冲突标记并手动解决" /> <label for="能识别冲突标记并手动解决">能识别冲突标记并手动解决</label>
- <input type="checkbox" name="验收清单-checklist" value="能使用-ide-的可视化工具解决冲突" /> <label for="能使用-ide-的可视化工具解决冲突">能使用 IDE 的可视化工具解决冲突</label>
- <input type="checkbox" name="验收清单-checklist" value="知道如何放弃合并或选择某一方版本" /> <label for="知道如何放弃合并或选择某一方版本">知道如何放弃合并或选择某一方版本</label>
