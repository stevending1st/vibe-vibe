...
- <input type="checkbox" name="验收清单-checklist" value="理解-github-flow-的六步流程" /> <label for="理解-github-flow-的六步流程">理解 GitHub Flow 的六步流程</label>
- <input type="checkbox" name="验收清单-checklist" value="能独立完成从创建分支到合并的完整流程" /> <label for="能独立完成从创建分支到合并的完整流程">能独立完成从创建分支到合并的完整流程</label>
- <input type="checkbox" name="验收清单-checklist" value="了解-github-flow-与-git-flow-的区别" /> <label for="了解-github-flow-与-git-flow-的区别">了解 GitHub Flow 与 Git Flow 的区别</label>
- <input type="checkbox" name="验收清单-checklist" value="掌握分支同步和-pr-最佳实践" /> <label for="掌握分支同步和-pr-最佳实践">掌握分支同步和 PR 最佳实践</label>
