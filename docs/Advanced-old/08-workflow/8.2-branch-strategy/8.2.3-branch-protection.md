...
- <input type="checkbox" name="验收清单-checklist" value="理解分支保护的必要性" /> <label for="理解分支保护的必要性">理解分支保护的必要性</label>
- <input type="checkbox" name="验收清单-checklist" value="能在-github-上配置基本的分支保护规则" /> <label for="能在-github-上配置基本的分支保护规则">能在 GitHub 上配置基本的分支保护规则</label>
- <input type="checkbox" name="验收清单-checklist" value="了解-ci-状态检查的集成方式" /> <label for="了解-ci-状态检查的集成方式">了解 CI 状态检查的集成方式</label>
- <input type="checkbox" name="验收清单-checklist" value="知道如何配置-codeowners" /> <label for="知道如何配置-codeowners">知道如何配置 CODEOWNERS</label>
