...
- <input type="checkbox" name="验收清单-checklist" value="理解五种分支类型的作用" /> <label for="理解五种分支类型的作用">理解五种分支类型的作用</label>
- <input type="checkbox" name="验收清单-checklist" value="能正确执行-feature-分支的创建和合并" /> <label for="能正确执行-feature-分支的创建和合并">能正确执行 feature 分支的创建和合并</label>
- <input type="checkbox" name="验收清单-checklist" value="理解-release-和-hotfix-的区别" /> <label for="理解-release-和-hotfix-的区别">理解 release 和 hotfix 的区别</label>
- <input type="checkbox" name="验收清单-checklist" value="了解-git-flow-的适用场景" /> <label for="了解-git-flow-的适用场景">了解 Git Flow 的适用场景</label>
