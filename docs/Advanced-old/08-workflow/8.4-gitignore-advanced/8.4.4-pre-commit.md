...
- <input type="checkbox" name="验收清单-checklist" value="配置了敏感文件的-pre-commit-检查" /> <label for="配置了敏感文件的-pre-commit-检查">配置了敏感文件的 pre-commit 检查</label>
- <input type="checkbox" name="验收清单-checklist" value="可选配置了-gitleaks-密钥扫描" /> <label for="可选配置了-gitleaks-密钥扫描">可选：配置了 gitleaks 密钥扫描</label>
- <input type="checkbox" name="验收清单-checklist" value="可选配置了大文件检查" /> <label for="可选配置了大文件检查">可选：配置了大文件检查</label>
- <input type="checkbox" name="验收清单-checklist" value="配置了-ci-层面的安全扫描" /> <label for="配置了-ci-层面的安全扫描">配置了 CI 层面的安全扫描</label>
