...
- <input type="checkbox" name="验收清单-checklist" value="配置了-env-的忽略规则" /> <label for="配置了-env-的忽略规则">配置了 .env* 的忽略规则</label>
- <input type="checkbox" name="验收清单-checklist" value="创建了-envexample-模板" /> <label for="创建了-envexample-模板">创建了 .env.example 模板</label>
- <input type="checkbox" name="验收清单-checklist" value="理解私钥证书的忽略方式" /> <label for="理解私钥证书的忽略方式">理解私钥证书的忽略方式</label>
- <input type="checkbox" name="验收清单-checklist" value="知道意外提交后的处理流程" /> <label for="知道意外提交后的处理流程">知道意外提交后的处理流程</label>
