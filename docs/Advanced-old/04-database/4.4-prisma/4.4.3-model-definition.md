...
- <input type="checkbox" name="验收清单-checklist" value="每个模型都有-id-主键" /> <label for="每个模型都有-id-主键">每个模型都有 `@id` 主键</label>
- <input type="checkbox" name="验收清单-checklist" value="必填字段没有加" /> <label for="必填字段没有加">必填字段没有加 `?`</label>
- <input type="checkbox" name="验收清单-checklist" value="外键字段类型与引用字段一致" /> <label for="外键字段类型与引用字段一致">外键字段类型与引用字段一致</label>
- <input type="checkbox" name="验收清单-checklist" value="一对一关系的外键有-unique" /> <label for="一对一关系的外键有-unique">一对一关系的外键有 `@unique`</label>
- <input type="checkbox" name="验收清单-checklist" value="需要搜索-排序的字段有索引" /> <label for="需要搜索-排序的字段有索引">需要搜索/排序的字段有索引</label>
- <input type="checkbox" name="验收清单-checklist" value="审计字段createdatupdatedat已添加" /> <label for="审计字段createdatupdatedat已添加">审计字段（createdAt、updatedAt）已添加</label>
