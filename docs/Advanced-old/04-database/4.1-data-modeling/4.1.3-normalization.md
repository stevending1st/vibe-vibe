...
- <input type="checkbox" name="范式检查清单-checklist" value="1nf所有字段都是原子值没有数组或逗号分隔的值" /> <label for="1nf所有字段都是原子值没有数组或逗号分隔的值">**1NF**：所有字段都是原子值？没有数组或逗号分隔的值？</label>
- <input type="checkbox" name="范式检查清单-checklist" value="2nf所有非主键字段都依赖于完整的主键" /> <label for="2nf所有非主键字段都依赖于完整的主键">**2NF**：所有非主键字段都依赖于完整的主键？</label>
- <input type="checkbox" name="范式检查清单-checklist" value="3nf非主键字段之间没有依赖关系" /> <label for="3nf非主键字段之间没有依赖关系">**3NF**：非主键字段之间没有依赖关系？</label>
